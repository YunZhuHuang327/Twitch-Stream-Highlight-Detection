...
from llama_cookbook.policies.mixed_precision import bfSixteen, bfSixteen_mixed, fpSixteen
...
def get_policies(fsdp_config, rank):
    """Get mixed precision and wrapping policies for FSDP.
    
    This is a replacement for the removed get_policies function from llama_cookbook.
    """
    ...
    # Wrapping policy will be set separately using fsdp_auto_wrap_policy
...
class Trainer:
    ...
    def fit(self, model_config, datamodule):
        self.model = main(dataset_train=datamodule, **model_config)
        return self.model
